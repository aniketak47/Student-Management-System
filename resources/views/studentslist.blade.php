            ...
            @foreach($students as $student)
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{ url('/show/'.$student->id) }}" class="btn btn-sm btn-warning">Show</a>
                        <a href="{{ url('/click_delete/'.$student->id) }}" class="btn btn-danger btn-sm">Delete</a>
                        
                    </td>
                    <!-- <td>
                        
                        <form action="{{ url('/click_delete/'.$student->id) }}" method="Get">
